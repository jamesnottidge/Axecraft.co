  ...
  return (
    <div className="bg-white rounded-lg shadow-sm mb-4 overflow-hidden">
      <button
        ...
        onClick={onClick}
      >
        <span className="text-black text-[16px] w-auto  md:text-[20px] font-medium">{question}</span>

        <div className={`md:h-14 md:w-14 h-7 w-7 ml-5 rounded-full border border-gray-200 bg-[#FAFFF5] flex items-center justify-center transition-transform duration-200 ${isOpen ? 'transform rotate-180' : ''}`}>
          <svg 
            width="15" 
            height="10" 
            viewBox="0 0 10 6" 
...
const FAQ = () => {
  const faqs = [
    ...
    {
      question: "What services does Axecraft offer?",
    ...
    {
      question: "Can I access Axecraft on mobile devices?",
      answer: "Absolutely! Axecraft offers seamless integration with major banking software, ERP systems, and accounting platforms through our API and pre-built connectors."
    },
  ];
    ...
    <section className="w-full bg-gray-50 ">
      ...
      <div className="container mx-auto px-6 w-full py-16 md:py-24">
        ...
        <div className="flex flex-col gap-10 lg:flex-row items-center lg:items-start ">
          ...
          <div className="w-full md:w-2/3 mb-8 md:mb-0 flex flex-col items-start gap-5" data-aos="fade-up">
          ...
          <div className="w-full md:w-3/3 md:pl-12">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
